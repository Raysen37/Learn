...
/* ShowGroud */
void OLED_ShowGround(uint8_t X, uint8_t Y, uint8_t Width, uint8_t Height, const uint8_t *Image, uint8_t pos, uint8_t speed)
{
	/* X:0 Y:56 W:128 H:8 */
	uint8_t ground_length = sizeof(GroundImg);
	uint8_t i, j;
	/*参数检查，保证指定图像不会超出屏幕范围*/
//	if (X > 127) {return;}
//	if (Y > 63) {return;}
...
/* ShowCloud */
void OLED_ShowCloud(int8_t X, uint8_t Y, uint8_t Width, uint8_t Height, const uint8_t *Image)
{
	/* X:100 Y:8 W:26 H:8 */
	uint8_t i, j;
...
/* show dionrun */
void OLED_ShowDinoRun(uint8_t X, uint8_t Y, uint8_t Width, uint8_t Height, const uint8_t *Image)
{
	uint8_t i, j;
...
/* show DinoJump */
void OLED_ShowDinoJump(uint8_t X, uint8_t Y, uint8_t Width, uint8_t Height, const uint8_t *Image)
{
	uint8_t i, j;
...
/* show cactus */
void OLED_ShowCactus(uint8_t X, uint8_t Y, uint8_t Width, uint8_t Height, const uint8_t *Image)
{
	uint8_t i, j;
...
/* show game over */
void OLED_ShowGameOver(uint8_t X, uint8_t Y, uint8_t Width, uint8_t Height, const uint8_t *Image,uint8_t over_flag)
{
	uint8_t i, j;
...
/* show crow fly */
void OLED_ShowCrowFly(uint8_t X, uint8_t Y, uint8_t Width, uint8_t Height, const uint8_t *Image)
{
	uint8_t i, j;
